...
describe('Searching restaurant', () => {
    ...
    describe('When query is not empty', () => {
        ...
        it('should show the name of the restaurants found by Favorite Restaurants', (done) => {
            document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
                const restaurantTiles = document.querySelectorAll('.restaurant__title');
                expect(restaurantTiles.item(0).textContent).toEqual('restaurant abc');
                expect(restaurantTiles.item(1).textContent).toEqual('ada juga restaurant abcde');
                expect(restaurantTiles.item(2).textContent).toEqual('ini juga boleh restaurant a');
